...
const LoginController = {
  ...
  /**
   * La méthode de login, lorsque l'application fera la requête pour s'identifier, c'est ici que se trouve la logique de vérification des identifiants et le retour de la requête avec soit un message d'erreur soit un message de succès avec le token (tel que je l'ai imaginé, adaptes en fonction ton implémentation)
   * @param req 
   * @param res 
   */
